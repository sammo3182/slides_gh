...
class: center, middle, normal, large

## Brief

.red[National image building] (NIB) and resilience

--

.red[Confucius Institutes] (CIs) in the U.S. 
...
Do the closures .red[eliminate] the NIB effort,     
...
.center[<img src="images/nationalImage.jpg" height = 350 width = 500>]
...
## Missing Fact: NIB resilience

### Well observed 

(N. Abu-Nasr 2019; Ainslie, Lipura, and Lim 2017; Cowen 2007; PTI 2016, ; Riley and Horowitz 2021; Russia Today 2021; Sishuwa 2019)
...
+ Planned 2002 and led by *Hanban*<sup>\*</sup>
...
.footnote[\* Managed by the Chinese International Education Foundation since 2020]
...
<img src="images/map_closed.gif" height = 450>
...
.center[<img src="images/privateVsPublic.jfif" height = 450>]
...
+ Drivers: Trade War &times; Public School
