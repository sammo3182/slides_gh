...
knitr: 
    opts_chunk:
      echo: false
bibliography: perceived_inequality.bib
format: 
  revealjs:
...
*Social volcano*: Escalating economic inequality &rarr; social unrest &rarr; shaking regime stability [@He2003]

- Expected ways to "erupt": *Connect the macro with the micro*
    - Relative deprivation [@Gurr1971]
...
:::{.notes}
Income inequality leads to increased social discontent, suppresses people's willingness to cooperate[@NishiEtAl2015], widens the Political participation gap between the poor and the rich[@SzewczykCrowder-Meyer2022], and intensifies social conflicts[@Gurr1971]. The "social volcano" theory is based on such social facts, suggesting that income inequality in China can lead to social unrest and threaten political stability[@GimpelsonTreisman2018; @Cramer2003; @ZhouJin2018a]. The issue of inequality has become a pressing social problem that needs to be addressed urgently.
:::


## Social Comparison and Inequality Perception
...
- &uarr; comparison &rarr; discontent [@Crosby1976; @Gurr1971]
- &darr; comparison &rarr; self-esteem [@Wills1981; @HopkinsBilimoria2008; @GibbonsGerrard1989]
- Reference: self-interest [@MeltzerRichard1981]; class [@DimickEtAl2017;@KulinSvallfors2013]; economic security [@HanKwon2020;@CondonWichowsky2020]

![](https://drhuyue.site:10002/sammo3182/figure/inequality_riceBowl.webp){.fragment fig-align="center" height=350}
:::
...
:::{.fragment}
$H_{2.1}$: &uarr; $\text{comparison}_{high\ income}$ &rarr; redistribution support [&darr;]{.green}

$H_{2.2}$: &darr; $\text{comparison}_{low\ income}$ &rarr; redistribution support [&uarr;]{.red}
:::
...
:::{.fragment}
$H_{3}$: Public sector employees &rarr; redistribution support [&darr;]{.green}
:::
...
- Outcome
    - Inequality perception: income fairness (1--4)
...
![](https://drhuyue.site:10002/sammo3182/figure/inequality_incomeGroups.png){.fragment fig-align="center" height=600}
:::
...
:::{layout-ncol=2}
![Low](https://drhuyue.site:10002/sammo3182/figure/Lowincome_Perceptions_of_Inequality.png){fig-align="center" height=250}

![Middle](https://drhuyue.site:10002/sammo3182/figure/Middleincome_Perceptions_of_Inequality.png){fig-align="center" height=250}

![High](https://drhuyue.site:10002/sammo3182/figure/Highincome_Perceptions_of_Inequality.png){fig-align="center" height=250}
:::
...
![Low-Unemployment](https://drhuyue.site:10002/sammo3182/figure/Lowincome_Unemployment_Insurance.png){fig-align="center" height=250}
...
![High-Pension](https://drhuyue.site:10002/sammo3182/figure/Highincome_Retirement_Pension.png){fig-align="center" height=250}
...
![](https://drhuyue.site:10002/sammo3182/figure/inequality_intlGini.png){.fragment fig-align="center" height=400}
