...
subtitle: "A Psychologial Analysis of Chinese Data"
author: 
  - HU Yue
  - HE Danna
  - LIN Kuo
...
knitr: 
    opts_chunk:
      echo: false
bibliography: p_taiwan_main.bib
format: 
  revealjs:
...
**Objective**: Pyschological traits of participants in online political discussions

**Theory**:  Pyschological orientation of participatory behaviors

**Data and Method**: 

- Weibo discussions about the 2024 Taiwan "Election"
...
- Size and outcome [&check;]{.green}
- Format  [&check;]{.green}
- Who participate❓
  - ![](https://drhuyue.site:10002/sammo3182/figure/tw_netizen.png){fig-align="center" height=400}
- Determinants of their behaviors❓

:::{.notes}
Young is not good enough. Be aware that 74% penetration rate, in every four people three is online.
:::
...
&darr;    
[&#x1F511; [Quality]{.red} of discussion]{.large}
:::
...
:::{.notes}
- Topic relevance refers to the coherence on the topic, ensuring that the discourse remains focused and pertinent [@Stromer2007; quoted in @FriessEilders2015]. Linguistic complexity is a composite variable that combines logical complexity and lexical complexity, providing an assessment of the sophistication and depth of the arguments presented. 
