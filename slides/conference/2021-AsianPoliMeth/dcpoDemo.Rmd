---
title: "Understanding Public Opinions Across Regions, Time, and Surveys"
subtitle: "New Method and New Evidence with Dynamic Comparative Public Opinion (DCPO)"
author: 
...
+ Methods to Handle Cross-Survey Comparisons

+ A New Method: Dynamic Comparative Public Opinion (DCPO)

+ Method Comparison

+ Application: Democracy &larr;?&rarr; Public support

---

## Cross-Region/Time/Survey Analysis

~~Meta analysis~~

+ .blue[Efficient] allocation
+ .blue[Diverse] perspectives
...
.center[IRT &rarr; Ordered IRT &rarr; DGIRT &rarr; ]
...
Stegmueller 2011+ Caughey & Warshaw 2016, DGIRT, Claassen 2019, 2020
...
Support .navy[&uarr;] &rarr; democracy) .navy[&uarr;] .small[(Claassen 2019)]
...
## Better Method + Enriched data

DCPO 

.center[<img src="images/irtFitCompare.png" height = 250 />]
...
1. Cross-section time-series diverse-question    .blue[DCPO]
    + `DCPO`
    + `DCPOtools`
