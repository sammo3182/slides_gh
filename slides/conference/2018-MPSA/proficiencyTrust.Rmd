...
* Relative
    + Suitability &#8686;
    + Hypotheses:
        + <font color="red">Better</font> self-evaluation and <font color="red">more</font> confidence in the regime
...
* DV: 
    ...
    + Self-evaluation
        + Comparing to their generation
    + **Political Trust**
        + Legislature, central government, local government, judiciary
...
* IV:
    ...
    + Post-stratification weights, wave binaries.

---

## Results

<img src="image/trust.png" height = 400 />
...
1. New insight into language policy
