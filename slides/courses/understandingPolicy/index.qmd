...
```{r slides}
ls_slides <- list.files(here("slides", "courses", "understandingPolicy"), 
                        pattern = "^\\d{2}_.*html$")
dir_slides <- paste0("/slides_gh/slides/courses/understandingPolicy/", ls_slides)
