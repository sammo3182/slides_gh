...
![](images/prob_dices.webp)
Throwing a dice five times/five dices

How many types of the outcome? 

:::

:::{.column width="50%" .fragment}
- W. replacement: $6^5$; 
- W/o replacement: $P(6, 5) = \frac{6!}{(6 - 5)!}.$ 
:::
::::
...
- What's the probability for Female who don't agree?
    - $Pr(FD) = 5/28.$ (marginal distribution)
- What's the probability of "yes" given the respondent is a male.
    - $P(Y|M) = 5/17.$ (conditional distribution)
