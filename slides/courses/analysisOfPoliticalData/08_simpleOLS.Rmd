...
\begin{align}
\sum X_i\hat u_i =& \frac{\sum(X_i - \bar X)(\hat u_i - \bar{\hat u_i})}{n} = cov(X_i, u_i)\\
...
var(\hat \beta_0|X) =& var(\bar Y - \hat\beta_1\bar X|X)\\
                  ...
                  =& var(\frac{\sum u_i}{n}|X) + var(\hat\beta_1\bar X|X), \beta_0 + \beta_1X_i\text{constant and two parts indp}\\
