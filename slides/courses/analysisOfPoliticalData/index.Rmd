...
schedule$day[schedule$day == "2023-10-02"] <- "2023-10-07"

midAutumn <- ymd(20230929)%--%ymd(20230930)
nationalDay <- ymd(20231001)%--%ymd(20231006)
newYear <- ymd(20231230)%--%ymd(20240101)
...
* <a href="/slides_gh/slides/courses/analysisOfPoliticalData/05_ciSample.html">`r schedule$caption[5]`</a>

* <a href="/slides_gh/slides/courses/analysisOfPoliticalData/06_hypothesis.html">`r schedule$caption[6]`</a>
