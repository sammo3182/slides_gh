...
Every unit change in X<sub>1</sub> leads to &beta;<sub>1</sub> changes in Y .magenta[on average], .red[holding everything else constant].
...
### Very high for a redundant or misspecified model
...
When can R<sup>2</sup> be useful?
