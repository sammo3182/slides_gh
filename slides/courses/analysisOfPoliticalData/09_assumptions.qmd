...
:::{.r-stack}
![](http://103.238.162.29:10002/webdav/sammo3182/figure/clrm_blue.png){.fragment height=600}

![](http://103.238.162.29:10002/webdav/sammo3182/figure/clrm_blue.gif){.fragment height=600}
...
![](http://103.238.162.29:10002/webdav/sammo3182/figure/clrm_ols.gif){fig-align="center" height=600}
...
1. [No autocorrelation/serial correlation]{.red}:  E(&epsilon;<sub>i</sub>, &epsilon;<sub>J</sub>|X<sub>i</sub>, X<sub>j</sub>) = cov(&epsilon;<sub>i</sub>, &epsilon;<sub>J</sub>|X<sub>i</sub>, X<sub>j</sub>) = 0, &forall; i, j);
...
:::{.fragment}
{{< video src="http://103.238.162.29:10002/webdav/sammo3182/video/clrm_commandments.mp4" width="500" >}}
