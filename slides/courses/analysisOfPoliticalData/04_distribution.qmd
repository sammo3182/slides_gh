...
:::{.r-stack}
![](images/dist_integral.gif){.fragment fig-align="center" height=500}

![](images/dist_pmfPdf.png){.fragment fig-align="center" height=500}
:::
...
:::{.fragment}
![](images/dist_rotation.gif){height=260}
:::
:::
...
![](images/dist_moments.png){height=400}
:::
::::
...
## About Means ![](images/ci_fsmrof.png){.lightbox fig-align="center" height=30}
...
![](images/prob_means.jpg){fig-align="center" height=num}
...
:::{.r-vstack}
![Jacob Bernoulli (1654--1705)](images/dist_Jakob_Bernoulli.jpg){height=200}

![Siméon Poisson (1781--1804)](images/dist_Poisson.jpg){height=200}
:::
...
:::{.r-vstack}
![Gerolamo Cardano (1501--1576)](images/dist_Cardano.jpg){height=200}

![Clarl F. Gauss (1777--1855)](images/dist_Gauss.jpg){height=200}
:::
...
:::{.column width="50%" .fragment}
![](images/dist_bernoulli_pmf.gif){height=250}
:::
::::
...
PDF: $f(k; n, p) = {n \choose k}p^k(1 - p)^{n - k}$ [*Why combination?*]{.small}
...
![](images/dist_binomial_pdf.png){.fragment fig-align="center" height=400}
:::
...
:::{.fragment}
Let's [assume]{.red} the employment of any student does not affect the chance of hiring others. [Why is this important?]{.fragment .small}
:::
...
![](images/dist_poisson.gif){height=400}
:::
...
![](images/dist_lotteryGenerator.gif){height=200 fig-align="center"}
...
::::{.columns}
:::{.column width="50%" .fragment}
![](images/ci_fsmrof.png){height=30} Discrete uniform distribution
...
![](images/dist_zScore.gif){.fragment height=400 fig-align="center"}
:::
...
::: {style="text-align: center"}
![](images/dist_mindmap.png){height="600"}
:::
