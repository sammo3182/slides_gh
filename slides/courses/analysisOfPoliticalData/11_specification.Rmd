...
when one of the models, e.g., f1 is the true model, then the combined version produces unbiased, consistent, yet inefficient estimates: 
...
1. Run $Y = f_2(X) + u$ and culculate the expected value $\hat Y = E[Y|f_2(X)]$
1. Run $Y = f_1(X) + \theta\hat Y + u$, and thest if &theta; = 0.
...
\begin{align}
cov(e, X) =& E(eX) - E(e)E(X) = E(eX)\\
          =& E[e(X^* + e)] = E(eX^*) + E(e^2) = \sigma_e^2\neq0\\
