...
- Understand missing data from OLS assumptions
    - Type of missingness
    - Consequences
...
- How to use linear regression to estimate discrete Ys
- Model fitness
:::
...
df_sim <- tibble(
  ...
  pivot_longer(cols = mcar:ni,
               ...
               values_to = "miss") %>% 
  mutate(missingness = factor(missingness, levels = c("mcar", "mar", "ni")), 
...
:::{.notes}
<img src="http://103.238.162.29:10002/webdav/sammo3182/figure/interpolation.png" height = 200 />
<img src="http://103.238.162.29:10002/webdav/sammo3182/figure/lm_extrapolation.png" height = 200 />
:::
...
:::{.notes}
<img src="http://103.238.162.29:10002/webdav/sammo3182/figure/censorTruncated.png" height = 200 />
:::
...
![](http://103.238.162.29:10002/webdav/sammo3182/figure/lm_multiuseTie.jpg){fig-align="center" height=200}
:::
...
![](http://103.238.162.29:10002/webdav/sammo3182/figure/lm_mindmap.png){fig-align="center" height=600}

## The Journey

![](http://103.238.162.29:10002/webdav/sammo3182/figure/ml_fullMindmap.png){fig-align="center" height=600}
