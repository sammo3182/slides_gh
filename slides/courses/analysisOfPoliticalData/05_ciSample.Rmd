...
.right-column[
+ **Unbiasedness**: Produce the .red[right] answer on coverage (😵).
    + E(p) = &pi;.
...
T critical points are relative to the d.f.
...
d.f. = 9 - 1 = 8, therefore t(&alpha; < .975) = `r qt(.975, df = 8)` (`qt(.975, df = 8)` in r).
