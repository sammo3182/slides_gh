...
:::{.r-vstack}
![](http://103.238.162.29:10002/webdav/sammo3182/figure/cor_etymology_association.png){.fragment fig-align="center" height=250}

![](http://103.238.162.29:10002/webdav/sammo3182/figure/cor_etymology_correlation.png){.fragment fig-align="center" height=250}

:::

## Covariance

> When a variable (X) changes, how is the other (Y)?
...
:::{.fragment}
Covariance is literally [co]{.red}-variance.
:::


## Correlation

> If one variable (X) is high, how about the other (Y)?

:::{.fragment style="text-align:center"}
:::{.callout-note}
Covariate vs. Correlation

:::{.r-hstack}
![](http://103.238.162.29:10002/webdav/sammo3182/figure/cor_covariance.gif){fig-align="center" height=200}

![](http://103.238.162.29:10002/webdav/sammo3182/figure/cor_correlation.webp){fig-align="center" height=200}
:::
...
1. Parametric test^[[Which means assuming normal distribution, linearity, and homoscedasticity.]{.fragment}]
1. [Not robust]{.red} to skewed data and outliers.

:::{.fragment}
**Limitation**

![](http://103.238.162.29:10002/webdav/sammo3182/figure/cor_linearity.webp){fig-align="center" height=300}
:::
...
Solving problem: Assumptions of linear correlation + non-parametric estimation
...
## Ranking in practice^[["Pairs" haven't been used yet so far.]{.fragment}]
...
- Properties:
    - Independent, &rho; = 0.
    - Not necessarily non-parametric
        - Option 1: Permutation (non-parametric)
        - Option 2: Fisher transformation (parametric), [$z={3(n_{c}-n_{d}) \over {\sqrt {n(n-1)(2n+5)/2}}}$]{.small}
...
## Calculate the pairs {auto-animate=true}
...
## Tau: Monotonic Correlation {.smaller}
...
t_{i}&={\text{Number of tied values in the }}i^{\text{th}}{\text{ group of ties for the first quantity, a.k.a., ties in x}}\\u_{j}&={\text{Number of tied values in the }}j^{\text{th}}{\text{ group of ties for the second quantity, a.k.a., ties in y}}
\end{aligned}
:::
...
## &chi;<sup>2</sup>: Categorical/Nominal Variables
...
+ $\overline X$, sample mean; the grant mean $\overline{\overline{X}} = \frac{\sum \overline{X_i}}{K}$, where K is column number.^[[ANOVA is usually used when $K \in [2, 3]$; for larger K, often use [MANOVA](https://www.sciencedirect.com/topics/medicine-and-dentistry/multivariate-analysis-of-variance) (rarely used in Poli Sci).]{.fragment}]
+ SST: Variance between the samples; SSE: Variance within the samples.^[[![](http://103.238.162.29:10002/webdav/sammo3182/figure/ci_fsmrof.png){height=20} &Chi;<sup>2</sup> is adding-up of n square normals representing variances; F is the ratio of two &chi;<sup>2</sup>s. *In other words, they are consistent with t-test and OLS.*]{.fragment}]
...
+ Randomized block design (i blocks, j groups)
  + Equivalent to matched sample in t-test^[[![](http://103.238.162.29:10002/webdav/sammo3182/figure/ci_fsmrof.png){height=30}Ranking version of ANOVA: Kruskal-Wallis test, Friedman test.]{.fragment}]
...
![](http://103.238.162.29:10002/webdav/sammo3182/figure/cor_mindmap.png){height="600"}
:::
...
![](http://103.238.162.29:10002/webdav/sammo3182/figure/cor_runs.png){fig-align="center"}
