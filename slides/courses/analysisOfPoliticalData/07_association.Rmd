...
E.g., Here are the cross-table of the partisan distribution of American fathers and sons. 
...
d.f.: (r - 1)(c - 1) = (3 - 1)(3 - 1) = 4, critical value is $\chi^2_{critical} = \chi^2_{0.05, 4} =$ `r qchisq(.975, df = 4)`.
