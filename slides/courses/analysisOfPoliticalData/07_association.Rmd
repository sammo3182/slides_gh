...
## When the Assumption Does Note Hold
...
Then, $\chi^2_{critical} = \chi^2_{0.05, 4} =$ `r round(qchisq(.975, df = 4), digits = 4)`< $\chi^2_{observed}$. H<sub>0</sub> is rejected.
...
## Association for Matched Sample
