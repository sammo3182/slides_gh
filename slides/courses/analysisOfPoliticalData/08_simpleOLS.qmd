...
* Efficiency: Smallest variance among *unbiased* estimators^[[![](http://103.238.162.29:10002/webdav/sammo3182/figure/ci_fsmrof.png){height=30} RMES: Root mean square error, $\sqrt{bias^2 + var}$.]{.fragment}]
...
:::{.r-hstack}
![](http://103.238.162.29:10002/webdav/sammo3182/figure/ols_leastSquare_correct.gif){.fragment height=400}
![](http://103.238.162.29:10002/webdav/sammo3182/figure/ols_leastSquare.gif){.fragment height=400}
:::

[Substantively: how does some outcome variable Y change [when]{.red} some explanatory variable X changes? ]{.fragment}

:::{.notes}

![](http://103.238.162.29:10002/webdav/sammo3182/figure/ols_illustrateSimpleOLS.png)
...
::: {.column width="60%"}
Given &beta;<sub>0</sub> = 0.6, &beta;<sub>1</sub> = 0.5.

![](http://103.238.162.29:10002/webdav/sammo3182/figure/ols_linearity.png)
:::
...
## OLS Formally^[[![](http://103.238.162.29:10002/webdav/sammo3182/figure/ci_fsmrof.png){height=30} &beta;: Estimand/parameter, function: estimator, result: estimate]{.fragment}]
...
## A Good Estimator &rarr; Minimizing Expected u<sub>i</sub> {.smaller}
...
:::{.fragment}
\begin{align}
\sum X_i(Y_i - \bar Y) =& \hat\beta_1\sum X_i(X_i - \bar X), \text{using the above}\\
...
## &beta;<sub>0</sub>^[[$\hat\beta_0, \hat\beta_1$ are called [co]{.red}efficients.]{.fragment}]
...
:::{.fragment}
\begin{align}
\text{Normal equations:} \sum Y_i =& n\hat\beta_0 + \hat\beta_1\sum X_i\\
\sum X_iY_i =& \sum X_i\hat\beta_0 + \sum\hat\beta_1 X_1^2
\end{align}
:::

## Linear nature of the OLS coefficient
...
::: {.column .fragment width="50%"}
Let $k_i=\frac{X_i - \bar X}{\sum (X_i - \bar X)^2},$ then $\hat\beta_1 = \sum k_i\beta_0 + \sum k_i X_i\beta_1 + \sum k_iu_i.$ 

+ A [linear]{.red} combination with errors^[[A special case: $\hat\beta_1 = \beta_1 + \sum k_iu_i$.]{.fragment}]
...
![](http://103.238.162.29:10002/webdav/sammo3182/figure/ols_minimizeSS.gif){fig-align="center" height=600}


## Var(&beta;<sub>1</sub>){.smaller}
...
::: {style="text-align: center"}
![](http://103.238.162.29:10002/webdav/sammo3182/figure/ols_mindmap.png){height="600"}
:::
