...
- Perspectives
  - Rational choice/Incremental model (micro) &larr; *strategic conditions*
    - System theory/Structural functionalism (macro) &larr; *institutional conditions*
      - Elitism (micro) &larr; *power conditions*
        - Group theory (meso) &larr; *organizational conditions*
- Process: How to make a decision &rarr; how to process a decision &rarr; whose call &rarr; call for what

![Offclass Quiz](https://drhuyue.site:10002/sammo3182/figure/lab_cesium1.jpg){.fragment fig-align="center" height=250}
...
::: {style="text-align:center; margin-top: 2em" .large}

> [我们必须坚持解放思想、实事求是、与时俱进、求真务实，一切从实际出发，着眼解决新时代改革开放和社会主义现代化建设的实际问题，不断回答中国之问、世界之问、人民之问、时代之问，作出符合中国实际和时代要求的正确回答，得出**符合客观规律的科学认识**，形成与时俱进的理论成果，更好指导中国实践。]{.red} [@XiJinPing2022a]
...
## Discussion  {.center background="#43464B"}

Discuss with your team members and answer the following questions:

1. Find two examples of correlation but [not]{.red} causation
1. Find two examples of correlation which [implies]{.green} causation
...
Evaluate the following experiment
...
![@BanerjeeEtAl2007](https://drhuyue.site:10002/sammo3182/figure/lab_BanerjeeDuflo.jpg){fig-align="center" height=400}
