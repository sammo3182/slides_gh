...
#| label: elevator30
#| echo: false
countdown(minutes = 0, seconds = 30, left = 1, play_sound = TRUE)

countdown(minutes = 0, seconds = 20, play_sound = TRUE)
```
...
1. Preparation
  - load the slides
  - adjust the microphone and clicker, etc.)
1. Presentation
1. Q & A
...
{{< video https://drhuyue.site:10002/sammo3182/video/prof_presentationGoal.mp4 title="课代表立正" height=400 preload="auto" controls allowfullscreen>}}
