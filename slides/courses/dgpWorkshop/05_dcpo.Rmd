...
Once or cross-sectional time-series (CSTS)
...
- Don't worry if it is not in English. A fair number of websites have an English version
    - Otherwise, modern browsers (Chrome, Edge, Firefox, etc.) have online translators.
...
Step 9: Create a folder named "FSD3494," which is the name of the downloaded file. 
Step 10: Save both the data and codebook there.

<img src = "images/dcpo_codebook.png" height = 550>
...
NB: Make sure you maintain the file name consistently.
...
https://services.fsd.tuni.fi/catalogue/series/26?tab=studies&lang=en
https://services.fsd.tuni.fi/catalogue/series/58?tab=studies&lang=en
https://services.fsd.tuni.fi/catalogue/series/81?tab=studies&lang=en
https://services.fsd.tuni.fi/catalogue/series/86?tab=studies&lang=en

https://services.fsd.tuni.fi/catalogue/series/14?tab=studies&lang=en
https://services.fsd.tuni.fi/catalogue/series/39?tab=studies&lang=en
https://services.fsd.tuni.fi/catalogue/series/47?tab=studies&lang=en

https://www.icpsr.umich.edu/web/ICPSR/series/51

https://www.cis.es/cis/opencm/ES/2_bancodatos/estudios/resBusqueda.jsp?nEstudioMin=&nEstudioMax=&mesIni=&anioIni=&mesFin=&anioFin=&muestraIni=&muestraFin=&publicado=3&cualitativo=3&ptitulo=inmigraci%C3%B3n&pcontenido=&ambito=0&universo=0&sexo=0&edad=0&btnBuscarE=

https://csrda.iss.u-tokyo.ac.jp/english/infrastructure/access/apply.html
