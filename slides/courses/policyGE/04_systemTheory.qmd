...
::: {.column width="60%"}
![](https://drhuyue.site:10002/sammo3182/figure/sys_systemXi.png){fig-align="center" height=600}
:::

::: {.column width="40%"}
1. What's a system (*in terms of public policy*)?
1. How to use system to understand policy?
:::
...
但到了3月12日，我记得很清楚，是个周六，下午我在社区群里看到，说三河市附近疫情散发，为了排除风险，燕郊封控管理两天，全域人员居家隔离。我立即决定回单位……我算幸运的，在路上堵了大概两小时，赶在3月13日零点前几分过了检查站，但后面一长串没过来的车，我听说他们都被劝返，只能调头回燕郊了。("在北京工作的廊坊人", 2022-06-20)
:::
...
:::{.r-hstack}
![](https://drhuyue.site:10002/sammo3182/figure/sys_yanjiao3.png){fig-align="center" height=600}
...
> [Energy]{.red} in the form of actions or [orientations]{.red} promoting and resisting a political system. --- David Easton (1957: 390)
...
:::{style="text-align:center"}
[Environment [&rarr;]{.red} system]{.normal}
...
:::{style="text-align:center"}
[Environment [&larr;]{.red} system ]{.normal}
