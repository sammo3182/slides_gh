...
1. Final project
    - Lower word-limit on the first assignment
    - Literature review &rarr; annotated bibliography
    - Proposal &rarr; slides
1. Challenge
    - More rounds, still single presenter
    - Best grade recorded
    - First round in the next week

## Overview 

![](https://drhuyue.site:10002/sammo3182/figure/rat_decisionMaking.webp){fig-align="center" height=400}
...
- Axiom I: Goal: Utility = [Earning]{.blue} - [Cost]{.red};
    - ${\displaystyle \mathrm {E} [u(X)]=\sum _{i}\;u(x_{i})\;P(x_{i}).}$^[i is the option; P(x) is the probability of x.]
...
## Adjusted Version of the Classic Model
...
![Bureaucratic organization model](https://drhuyue.site:10002/sammo3182/figure/rat_bureaucratOrg.webp){fig-align="center" height=300}
:::

::: {.column .fragment width="50%"}
![Belief system](https://drhuyue.site:10002/sammo3182/figure/rat_beliefSystem.webp){fig-align="center" height=300}
:::
...
![](https://drhuyue.site:10002/sammo3182/figure/rat_muddleThrough.jpeg){fig-align="center" height=400}
...
# Forming Options for the Decisions
