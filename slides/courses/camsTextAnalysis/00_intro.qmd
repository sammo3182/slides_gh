...
::: {.column width="40%"}
![](https://raw.githubusercontent.com/sammo3182/slides_gh/master/slides/courses/rWorkshop/images/apps.jpeg){fig-align="center" height=600}
:::
...
1. Download the files from the shared folder
1. Copy the models to the `drhur/inst/tutorials/`

:::{.fragment}

```{r rootPackage, echo = TRUE, eval = TRUE}
.libPaths()
```
