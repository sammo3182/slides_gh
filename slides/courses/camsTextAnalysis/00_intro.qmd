...
subtitle: "Data Science and Text Analysis, CAMS"
...
- W. linguistics
  ...
  - How language you speak [shape]{.red} the mind of politics

## Warm-up questions {background="#43464B"}

1. Why do you get up early today? 😝
...
1. (Sharper) Do you still need to learn natural language process in the age of large language model (LLM)?
...
Three misconceptions (based on the interviews with students of universities around the country):
