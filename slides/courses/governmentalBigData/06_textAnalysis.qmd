---
title: "以数知文"
subtitle: "深圳大学·当代中国政治发展论坛"
author: "胡悦"
institute: 
  - 清华大学社会科学学院
  - 清华大学计算社会科学与国家治理实验室（计算社会科学平台）
  - 清华大学数据治理中心
...
## 文本分析的基础原则（[红线]{.red}） [@GrimmerStewart2013]
...
[解法: 词频加权 e.g., term frequency-inverse document frequency (TF-IDF)]{.fragment}
...
## 加权之上：Bring the context back

- 临近词分析:  Markov Model of Order N
    + Unigram: 清华 大学 政治 系
