---
title: "持续期分析事件史分析（Duration Modelin）"
subtitle: "及事件史分析（Event Historyg）"
...
[2] Often used to refer to continous model
...
由于不是完全parametric，所以很难进行假设检验，因此在政治学中较少直接使用。
