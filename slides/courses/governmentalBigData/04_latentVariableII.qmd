...
![离散回应模型](https://drhuyue.site:10002/sammo3182/figure/lv_irt.webp){fig-align="center" height=400}
:::
...
![基于单一潜在变量的划分“三六九等" (Queen's Gambit)](https://drhuyue.site:10002/sammo3182/figure/lv_game.jpg){fig-align="center" height=200}

:::: {.columns}

::: {.column .fragment width="50%"}
![](https://drhuyue.site:10002/sammo3182/figure/lv_lord.png){fig-align="center" height=300}
...
$$P(Y_{ip}, Y_{iq}|\theta_i) = P(Y_{ip}|\theta_q)P(Y_{iq}|\theta_i),$$
...
+ &theta;<sub>i</sub>&isin;{-&infin;, +&infin;}: 反应能，(Unbounded latent trait)
