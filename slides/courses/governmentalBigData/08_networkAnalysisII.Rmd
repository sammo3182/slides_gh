...
.center[Relative likelihood of observing N<sup>i+</sup> to observing N<sup>i-</sup>]
...
1. Degeneracy： unstable results, random process, model fit; specify too many things, leading to prediction that everyone should connect to everyone or none
