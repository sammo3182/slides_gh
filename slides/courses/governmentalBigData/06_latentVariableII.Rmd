...
```{r pi-map, fig.height=8, fig.width=10}
...
```{r ltm}
res_rm_2 <- rasch(df_verbal) # replicate the rasch for later comparison
res_2pl_1 <- ltm(df_verbal ~ z1)
...
```{r ltm-icc, fig.height=8, fig.width=10}
plot(res_2pl_1)
```
...
N<sub>z</sub> * weighted mean / n<sub>z</sub>
...
.center[<img src="images/irtFitCompare.png" height = 400 />]
...
1. $$S_1 = [0.5\; 0.5]\begin{bmatrix}0.8 & 0.2\\ 0.6 & 0.4 \end{bmatrix}=[0.7\; 0.3]$$
1. $$S_2 = [0.7\; 0.3]\begin{bmatrix}0.8 & 0.2\\ 0.6 & 0.4 \end{bmatrix}=[0.74\; 0.26]$$
1. $$S_3 = [0.74\; 0.26]\begin{bmatrix}0.8 & 0.2\\ 0.6 & 0.4 \end{bmatrix}=[0.748\; 0.252]$$
1. $$S_4 = [0.748\; 0.252]\begin{bmatrix}0.8 & 0.2\\ 0.6 & 0.4 \end{bmatrix}=[0.749\; 0.250]$$
