...
:::{.r-fit-text}
[政]{.blue}务大数据 &sub; [政]{.blue}治[科学]{.red}研究&sub; 社会[科学]{.red}研究
:::
...
![](images/stat_curiosity.jpg){height=850}
...
![](images/stat_yangQian.gif){height=350}
:::
...
![](images/stat_yuXuanji.jfif){height=350}
...
![](images/stat_bookOfWhy.jpg){height=350 style="text-align: center"}
:::
...
:::{.column width="70%" .fragment}
![](images/stat_statProcess.png){height=800}
:::
::::
...
![](images/stat_concepts.png){height=800}
...
![](images/stat_tidydata.png){height=600}
...
![](images/stat_patrioBase9705.gif){height=750}
:::

:::{.column width=50% .fragment}
*总体比较分析*

![](images/stat_loyal.png){height=750}
:::
::::
