...
![今天，让我们成为生物学家](https://drhuyue.site:10002/sammo3182/figure/sur_experiment.jpg){ fig-align="center" height=300}
...
&mu; = &lambda;; &sigma;<sup>2</sup> = &lambda;.
...
# 生成过度离散数据（负二项分布）
overdispersed_data <- rnbinom(10000, size = 20, mu = 3)
...
{{< video https://drhuyue.site:10002/sammo3182/video/sur_tightrope.mp4 title="一个轻松的视频" height=600 loading="eager" allowfullscreen>}}
