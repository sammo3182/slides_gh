---
title: "潜在变量分析（基础）"
subtitle: "Learning Latent Variable Analysis with Dr. Hu (Basic)"
author: "胡悦"
...
.pull-right[
```{r parallelAnalysis, fig.align='center', fig.height=7, results='hide'}
df_big5 %>%
  select(8:57) %>%
  fa.parallel(fa = "fa")
```
...
.pull-right[
```{r diagram-cfa, fig.align='center', fig.height=3}
