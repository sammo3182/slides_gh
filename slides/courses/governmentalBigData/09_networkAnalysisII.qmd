...
![](https://drhuyue.site:10002/sammo3182/figure/sna_agglomerativeDivisive.bmp){height=600 fig-align="center"}
...
fg_compound <- ggplot(data_compound, aes(x, y)) +
  geom_point(size = 2)
...
fg_spectral <- ggplot(data_compound, aes(x, y, color = class)) +
  geom_point(size = 2) +
  ggtitle("Spectral")
...
fg_dbscan <- ggplot(data_compound, aes(x, y, color = class)) +
  geom_point(size = 2) +
  ggtitle("DBSCAN")
