---
title: "计算机辅助文本分析概论"
subtitle: "Dr. Hu's Intro to Text Analysis"
...
the Hamming distance between two strings of equal length is the number of .navy[positions] at which the .red[corresponding symbols are different]. 
