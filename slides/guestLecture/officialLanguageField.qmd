...
1. *Language* is [not a proxy]{.red}
1. *Language effects* are [not exogeneous]{.red}
1. *Policy-conditioned language effects* are [not unidirectional]{.red}


**Implication**: 

- Understanding of language effects on politics
- Role of language policy and governance
- Language plan on modernization
...
:::{.r-stack}
:::{.r-hstack}
![Language is exogeneous](https://drhuyue.site:10002/sammo3182/figure/speak_lingBase.png){fig-align="center" height=550}

![Language represents identities](https://drhuyue.site:10002/sammo3182/figure/speak_languagePlan_macau.jpg){.fragment fig-align="center" height=550}
:::
