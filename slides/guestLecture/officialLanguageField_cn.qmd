...
**目标**: 语言效应（language effects）与背后的政治因素
...
1. 语言*不都是*身份或文化的代理变量，*而且是*具有多重[路径]{.red}的复杂变量；
1. 语言作用*不仅是*外生的，*而且是*受到[政策]{.red}塑造的；
1. 语言作用*不全是*定性的，*而且是*[定量]{.red}的。
:::
...
![@Hu2025](https://drhuyue.site:10002/sammo3182/figure/speak_litTree.png){fig-align="center" height=600}
...
![](https://drhuyue.site:10002/sammo3182/figure/listen_marginOfficial.png){fig-align="center" height=600}
