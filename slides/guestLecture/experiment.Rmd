...
$\delta_i = Y_{0i} - Y_{1i}$, 我们能同时看到 $Y_{0i}$ 和 $Y_{1i}$ 吗？

.center[<img src = "../courses/analysisOfPoliticalData/images/prob_multiverse_rickMordy.gif" height = 450>]
...
## Counterfactual Logic & Principles of the Experimental Method
# 反事实逻辑与实验逻辑
...
<img src="images/face2face.jpg" height = 250, width = "32%" />
<img src="images/hotline.jpg" height = 250, width = "32%" />
<img src="images/online.jpg" height = 250, width = "32%" />
</div>
...
<div>
<img src="images/duichi.jpg" height = 350, width = "49%" />
<img src="images/sentiment.png" height = 350, width = "49%" />
</div>
