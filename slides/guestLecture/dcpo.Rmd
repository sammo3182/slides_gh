...
+ Invariance among respondents<sup>\*</sup>
    + Easy to be avoide when involving multip group IRT
...
.center[.orange[Pr(y<sub>iq</sub> = 1)] = .navy[logist<sup>-1</sup>(&theta;<sub>i</sub> - &sigma;<sub>q</sub>])]
