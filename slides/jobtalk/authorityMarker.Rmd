...
.pull-right[<img src="image/diaPyramid.png" height = 400 />]
...
## Test Language Attitudes in the Real life
...
* Questions on each speaker respectively.
    ...
    + Emotional trust (IOS measurement)
    + Content trust ("Given there is one department in the recording actually responsible to the complaint, which department do you think it is, City Department of Property Management or Municipal Construction Committee?")
...
* .magenta[Distrust] $\leadsto$ .magenta[trust] > Trust $\leadsto$ Super trust
...
.center[<img src="image/languageMatters.png" height = 400 />]
...
<i class="fa fa-user-circle fa-lg"></i>&nbsp; https://sammo3182.github.io/
