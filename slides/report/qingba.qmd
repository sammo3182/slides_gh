...
![](https://drhuyue.site:10002/sammo3182/figure/qingba_frontpage.png){fig-align="center" height=500}
...
以认知视角探索理性主义-制度主义理论融合难题的[破解之法]{.red}。
...
- **作用**：挖掘[治理工具的认知塑造效用]{.red}，揭示纪检监察、民情疏导、城市管理等重要领域中潜藏问题，并提供破解思路 [（*Journal of Chinese Political Science* 2022；*Journal of Contemporary China* 2023等）]{.small .navy}
...
<div style="display: flex; gap: 0; margin: 0; padding: 0px;width:105%;">
  <img src="https://drhuyue.site:10002/sammo3182/figure/qingba_pub_cognition.jpg" style="width:100%;; height:50%; margin:0; padding:0; border:0;" />
  <img src="https://drhuyue.site:10002/sammo3182/figure/qingba_poq.png" style="width:100%;; height:30%; margin:0; padding:0; border:0;" />
</div>
...
由认知路径探索语言效果机制，构建[对语-政关系政治心理学解释]{.red}。
...
- **权威**：以语言学与政治学交叉视角，检验语言对[过程性政治信任]{.red}的影响，揭示语言的[权威标记效应]{.red}作用机制。[（POPS 2025；《语言文字应用》 2025）]{.small .navy}
- **习得**：以认知路经探索外语习得的社会政治影响，发现英语改变[个人现代性]{.red}作用及机制过程。[（*Journal of East Asian Studies* 2020;《治理研究》 2022）]{.small .navy}
- **塑造**：以语言场域理论视角，挖掘语言政策的治理功能，以及对[政治概念认知、决策偏好塑造]{.red}等方面广泛塑造作用。[（*Democratization* 2020；*China: An International Journal* 2022等）]{.small .navy}
:::

::: {.column width="50%"}

<div style="display: flex; gap: 0; margin: 0; padding: 0px;width:105%;">
  <img src="https://drhuyue.site:10002/sammo3182/figure/qingba_pub_language.png" style="width:100%; height:210px; margin:0; padding:0; border:0;" />
  <img src="https://drhuyue.site:10002/sammo3182/figure/theoryDiagram_3a.png" style="width:100%; height:300px; margin:0; padding:0; border:0;" />
</div>
...
[不止步于应用]{.red}，发展民意测量和比较的前沿方法，在国际高水平平台发出[中国方法论学者声音]{.red}。
...
- **测量方法创新**：创立软实力新测量，推动[软硬实力关系理论发展]{.red}[（《世界经济与政治》2023）]{.small .navy}
- **比较方法创新**：基于贝叶斯统计+极化控制，创立[动态民意比较新方法]{.red}DCPO [（*Political Science Research and Methods* 2025；*Research & Politics* 2025）]{.small .navy}
- **方法论建设**：厘定跨时空分析的数据出路规范，明确实验方法在政治学应用的[范畴和评价标准]{.red} [（*PS: Political Science & Politics* 2025；《国外理论动态》 2021）]{.small .navy}
...
<div style="display: flex; gap: 0; margin: 0; padding: 0px;width:105%;">
  <img src="https://drhuyue.site:10002/sammo3182/figure/qingba_pub_method.png" style="width:100%; height:50%; margin:0; padding:0; border:0;" />
  <img src="https://drhuyue.site:10002/sammo3182/figure/qingba_macrointerest.png" style="width:100%; height:32%; margin:0; padding:0; border:0;" />
</div>
