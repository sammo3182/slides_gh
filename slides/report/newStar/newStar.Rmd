...
**创新型强**：国际顶刊发表高水平论文
- 创刊以来.red[**前10**]由大陆学者作为一作/通讯发表论文；
- 学科三大顶刊（APSR, AJPS, JOP）已发.red[**其二**]；
- 突破话语壁垒，国际政治学首刊.red[**首位**]大陆（共同）一作+通讯；
...
| **Hu, Y.\***                    	| 2020     	| Political Psychology<br>(创刊于1920年，约71篇/年)              	| .red[**SSCI A+**]<br>IF: 4.333 	| &nbsp;&nbsp;&nbsp;&nbsp;.red[**第3篇**]<br>(共3篇，独作第2) 	|
| **Hu, Y.\***                      	| 2020     	| Democratization<br> (创刊于1994年，约103篇/年)                  	| .red[**SSCI A**]<br>IF: 3.055  	| &nbsp;&nbsp;&nbsp;&nbsp;.red[**第8篇**]<br>(共10篇，独作第5)          	|
]
...
- **敏感问题考察**: Tang, W., & .red[**Hu, Y.\\***] (2022). Detecting Grassroots Bribery and its Sources in China: A Survey Experimental Approach. *Journal of Contemporary China*, Forthcoming. (.red[**SSCI A+**], IF: 3.748，.red[**地区研究期刊国际排名第二**])
...
- **方法论**：.red[**胡悦\\***]. (2021). 实验室实验：政治科学研究的一种有效方法? 《国外理论动态》, 06, 160–171. (.red[**CSSCI**], IF: 1.109，发表四月.red[**下载190次**]，.red[**人大复印报刊资料转载**])
...
.center[主持国自科、北京社科等科研项目.red[**6**]项，获得科研资助累计.red[**160.88万**]，另作为主要人员参与6项]
...
谷歌学术被引用量是对标组约.red[**1.9倍**]，H-index是国内对标组约.red[**1.7倍**]
]
...
除学术影响力外，我还注重学术转化，运用所学帮助政府解决实际治理难题，我牵头队伍产出的研究报告已经获得了国家领导和北京市领导肯定批示。
