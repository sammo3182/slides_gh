...
- 近五年22篇（准聘后[17篇]{.red}）    
  - 包括***American Political Science Review***, *Political Psychology*《世界经济与政治》 等学科和领域顶刊，JCR Q1区[8篇]{.red}
...
- 建立跨越144个国家30余年民主支持的**可比性度量**，检验与制度变化关系
- 民众支持**不**影响制度变化，**也不**受制度变化影响（认知能动性），只对经济、腐败等有响应
